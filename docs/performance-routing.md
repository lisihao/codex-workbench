# Workbench 性能路由：1.13.0 源码合同、历史基线与 Spark P0

状态：`1.13.0 源码合同 / 源码版本`
升级前正式服务基线：`v1.12.1 / 6848bf7`；本文描述仓库源码合同，不声明任何用户安装或运行主机已完成升级，也不表示 Mac mini 已启用分类器。
...
以下是 c7a0df4 源码版本的当前语义；旧版详述从第 2 节起仅作为 v1.11.0 历史基线保留，
